...
const PostsListPage = (props) => {
  ...
  return (
    <div className="container-fluid px-4 probando">
      <div  className={"container row d-flex justify-content-center mx-5 pt-2  backgroundColor " + theme}>
        {posts.map((post, index) => {
          return(
            <div key={post._id} className="col-4 mx-0 ms-0 m-1 mb-2  p-2 fondo rounded ">            
                
                  <div className="card text-start shadowBorde p-1 col ">
