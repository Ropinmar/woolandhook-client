    ...
    <div>
     <div className="ag-page-404">
        <div className="ag-toaster-wrap">
          ...
          <img className="ag-canvas-404_img" src="https://raw.githubusercontent.com/SochavaAG/example-mycode/master/pens/404-error-smoke-from-toaster/images/smoke.png" alt=""/>
        </div>
      </div>
    </div>
  );
